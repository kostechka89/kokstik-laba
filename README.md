...
- `app/cache.py` — Redis-кэш новостей, пользователей и refresh-сессий
- `app/celery_app.py` — настройка Celery и расписания
- `app/tasks.py` — фоновые задачи уведомлений
...
Кратко описано в `docs/cache`.

## Уведомления

Кратко описано в `docs/notifications`.
